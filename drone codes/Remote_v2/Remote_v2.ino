...
// sendData(valueRoll, valuePitch, valueThrottle, valueYaw, aux1, aux2, duration )
    ...
    if( auxsState[ 2 ] == HIGH ){
        // sendData( avec des valeurs fixées, min 988, mid 1500, max 2011, sinon glitch ); 
          sendData( valueRoll, valuePitch, valueThrottle, 2000, auxsState[ 0 ], auxsState[ 1 ], 600);
          delay(100);
          sendData( valueRoll, valuePitch, valueThrottle, 1000, auxsState[ 0 ], auxsState[ 1 ], 600);
    }else if( auxsState[ 3 ] == HIGH ){
        // sendData( avec des valeurs fixées, min 988, mid 1500, max 2011, sinon glitch );
          sendData( valueRoll, valuePitch, 2000, valueYaw, auxsState[ 0 ], auxsState[ 1 ], 100 );
          delay(10);
          sendData( valueRoll, valuePitch, 1000, valueYaw, auxsState[ 0 ], auxsState[ 1 ], 100 );
            sendData( valueRoll, valuePitch, 2000, valueYaw, auxsState[ 0 ], auxsState[ 1 ], 100 );
          delay(10);
          sendData( valueRoll, valuePitch, 1000, valueYaw, auxsState[ 0 ], auxsState[ 1 ], 100 );
            sendData( valueRoll, valuePitch, 2000, valueYaw, auxsState[ 0 ], auxsState[ 1 ], 100 );
