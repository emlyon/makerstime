...
public class SUNFOUNDER_GROUND_CONTROL_STATION extends PApplet {
...
//tBARO   =         controlP5.addToggle("BARO",true,x,y3 ,20,10).setColorActive(color(125, 125, 125)).setColorBackground(black).setLabel(""); //ooo 9
 ...
 // debug2Slider  =    controlP5.addSlider("debug2Slider",-32768,+32767,0,x+250,y6,50,10).setDecimalPrecision(0).setLabel("");
  ...
  for( i=0;i<PIDITEMS;i++) {
    ...
    confP[i].setColorBackground(red_).setMin(0).setDirection(Controller.HORIZONTAL).setDecimalPrecision(1).setMultiplier(0.1f).setMax(20).moveTo("Config");
    confI[i] = (controlP5.Numberbox) hideLabel(controlP5.addNumberbox("confI"+i,0,xParam+75+135+35,yParam+20+i*28+cg-80,60,22));
    confI[i].setColorBackground(red_).setMin(0).setDirection(Controller.HORIZONTAL).setDecimalPrecision(3).setMultiplier(0.001f).setMax(0.250f).moveTo("Config");
 ...
 // confINF[5].setLabel("Acc ArmedTime").setMin(0).setMax(360000).setColorBackground(red_).moveTo("Config");
  ...
  confP[4].setDecimalPrecision(2).setMultiplier(0.01f).setMax(5).moveTo("Config");
  confI[4].setDecimalPrecision(1).setMultiplier(0.1f) .setMax(2.5f).moveTo("Config");
  
  confP[5].setDecimalPrecision(1).setMultiplier(0.1f) .setMax(25).moveTo("Config");
  confI[5].setDecimalPrecision(2).setMultiplier(0.01f).setMax(2.5f).moveTo("Config");
  confD[5].setDecimalPrecision(3).setMultiplier(.001f).setMax(.250f).moveTo("Config");
  
  confP[6].setDecimalPrecision(1).setMultiplier(0.1f) .setMax(25).moveTo("Config");
  confI[6].setDecimalPrecision(2).setMultiplier(0.01f).setMax(2.5f).moveTo("Config");
  confD[6].setDecimalPrecision(3).setMultiplier(.001f).setMax(.250f).moveTo("Config");
  ...
  rollPitchRate.setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).setColorBackground(red_).setMultiplier(0.01f).moveTo("Config");
  ...
  yawRate.setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).setColorBackground(red_).setMultiplier(0.01f).moveTo("Config"); 
  ...
  dynamic_THR_PID.setMultiplier(0.01f).setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).setColorBackground(red_).moveTo("Config");

  confRC_RATE = controlP5.addNumberbox("RC RATE",1,xParam+40+135,yParam+38+4*17+cg-50,60,22).setDecimalPrecision(2).setMultiplier(0.01f).setLabel("");
  confRC_RATE.setDirection(Controller.HORIZONTAL).setMin(0).setMax(2.5f).setColorBackground(red_).moveTo("Config");
  confRC_EXPO = controlP5.addNumberbox("RC EXPO",0,xParam+40+135,yParam+38+5*17+cg,60,22).setDecimalPrecision(2).setMultiplier(0.01f).setLabel("");
  ...
  throttle_MID = controlP5.addNumberbox("T MID",0.5f,width*(xParam+172)/1600,height*(yParam+136+5*17)/900,width*60/1600,height*22/900).setDecimalPrecision(2).setMultiplier(0.01f).setLabel("")
  .setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).setColorBackground(red_).moveTo("Config");//zzz
  
  throttle_EXPO = controlP5.addNumberbox("T EXPO",0,xParam+40+135,yParam+21+4*17+cg,60,22).setDecimalPrecision(2).setMultiplier(0.01f).setLabel("")
...
textSize(width/60); 
 ...
 pushMatrix();
 //scale(1.8);
    image(lp,width*750*1.8f/1600,height*50*1.8f/900,width*70*1.8f/1600,height*70*1.8f/900);
   stroke(255);
  a=min(confRC_RATE.value(),1);
  b=confRC_EXPO.value();
  strokeWeight(1);
  line(width*xSens1*1.8f/1600,height*(ySens1-90)*1.8f/900,width*xSens1*1.8f/1600,height*(ySens1-55)*1.8f/900);//bobo
  line(width*xSens1*1.8f/1600,height*(ySens1-55)*1.8f/900,width*(xSens1+70)*1.8f/1600,height*(ySens1-55)*1.8f/900);
  ...
  for(i=0;i<70;i++) {
    ...
    point(width*1.8f*(xSens1+i)/1600,height*1.8f*(ySens1+(70-val)*3.5f/7-90)/900);
  }
  if (confRC_RATE.value()>1) { 
    stroke(220,100,100);
    ellipse(width*1.8f*(xSens1+70)/1600, height*1.8f*(ySens1-90)/900, width*1.8f*7/1600, height*1.8f*7/900);
  }
  ...
  strokeWeight(1);stroke(255);
   line(width*1.8f*xSens2/1600,height*1.8f*(ySens2-90)/900,width*1.8f*xSens2/1600,height*1.8f*(ySens2-55)/900);
   line(width*1.8f*xSens2/1600,height*1.8f*(ySens2-55)/900,width*1.8f*(xSens2+70)/1600,height*1.8f*(ySens2-55)/900);
  ...
  for(i=0;i<70;i++) {
    ...
    val = rccommand*70/1000;
    point(width*1.8f*(xSens2+i)/1600,height*1.8f*(ySens2+(70-val)*3.5f/7-95)/900);
  }
  line(width*1.8f*(xSens2+(max(1100,RCChan[RCThro])-1100)*70/900)/1600,height*1.8f*(ySens2-70)/900,width*1.8f*(xSens2+(max(1100,RCChan[RCThro])-1100)*70/900)/1600,height*1.8f*(ySens2-60)/900);
...
// motor background
 //rect(xMot-5+40,yMot-20+140-50, xMot+145+110, yMot+150+140);//3.15
   rect(width*1.8f*xParam/1600,height*1.8f*yParam/900, width*1.8f*(xParam+555)/1600, height*1.8f*(yParam+200)/900);
  /* fill(255);
  textFont(font15); 
  pushMatrix();
 ...
 for( i=0;i<PIDITEMS;i++) {
    ...
    confP[i].setMin(0).setDirection(Controller.HORIZONTAL).setDecimalPrecision(1).setMultiplier(0.1f).setMax(20).moveTo("Config");
    confI[i].setPosition(width*(xParam+245)/1600,height*(yParam+i*28+cg-60)/900).setSize(width*64/1600,height*22/900);
    confI[i].setMin(0).setDirection(Controller.HORIZONTAL).setDecimalPrecision(3).setMultiplier(0.001f).setMax(0.250f).moveTo("Config");
 ...
 // confINF[5].setLabel("Acc ArmedTime").setMin(0).setMax(360000).setColorBackground(red_).moveTo("Config");
  ...
  rollPitchRate.setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).setMultiplier(0.01f).moveTo("Config");
  
  yawRate.setPosition(width*(xParam+395)/1600,height*(yParam+cg-6)/900).setSize(width*70/1600,height*25/900);
  yawRate.setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).setMultiplier(0.01f).moveTo("Config"); 
  
  dynamic_THR_PID.setPosition(width*(xParam+485)/1600,height*(yParam+cg-58)/900).setSize(width*70/1600,height*25/900);
  dynamic_THR_PID.setMultiplier(0.01f).setDirection(Controller.HORIZONTAL).setMin(0).setMax(1).moveTo("Config");
  ...
  confRC_RATE.setDirection(Controller.HORIZONTAL).setMin(0).setMax(2.5f).moveTo("Config");
...
// background(255);  
   ...
   // pushMatrix();
   // scale(1.8);
    image(tt,width*1.8f*750/1600,height*1.8f*70/900,width*1.8f/16,height*1.8f/9);
    fill(0, 0, 0);
  strokeWeight(3);stroke(0);
  rectMode(CORNERS);
 rect(width*1.8f*(xRC-505)/1600,height*1.8f*(yRC+35)/900, width*1.8f*(xRC-35)/1600,height*1.8f*(yRC+225)/900);
 popMatrix();
 fill(poppig);
  textFont(font35);
 textSize(width/60);
 ...
 TX_StickSlider[RCRoll ].setPosition(width*(xRC-350)/1600,height*(yRC+140)/900).setSize(width*840/1600,height*30/900);
  ...
  int y6= yGraph+205; //DEBUG
      ...
      zheng();
       //chang();
        addctid6();
        image(paper,width*0.08f,height*0.122f,width/16,height/9);
       fill(0);
       //textFont(font55);
       textSize(width/60);
       ...
       pushMatrix();
        translate(width/16,height*0.10555f);
       //translate(100,95);
       textFont(font35);
       textSize(width*0.015625f);
...
//    servoSliderH[3].setPosition(xMot,yMot-5) .setCaptionLabel("N/A").show();
 ...
 size=29;
  ...
  strokeWeight(4);stroke(255,255,100);line(0,0, 0,height*-2.4f*size/900);line(0,height*-2.4f*size/900, width*-5/1600 ,height*(-2.4f*size+10)/900); line(0,height*-2.4f*size/900, width*+5/1600 ,height*(-2.4f*size+10)/900);  //line direction
  rotate(-GPS_directionToHome*PI/180);
  // compass quadrant
  strokeWeight(1.5f);fill(0);stroke(0);
  ellipse(0,  0,   width*(2.6f*size+10)/1600, width*(2.6f*size+10)/1600);
  // Compass rotating pointer
  stroke(255);
  rotate(head*PI/180);
  line(0,height*size*0.2f/900, 0,height*-size*1.3f/900); line(0,height*-size*1.3f/900, width*-5/1600 ,height*(-size*1.3f+10)/900); line(0,height*-size*1.3f/900, width*+5/1600 ,height*(-size*1.3f+10)/900);
  popMatrix();
  // angles  zhinanzhen
  pushMatrix();
  ...
  for (i=0;i<=12;i++) {
    ...
    if (i%3!=0) {
      stroke(75);
      line(width*(xCompass+cos(angCalc)*size*2-300)/1600,height*(yCompass+sin(angCalc)*size*2)/900,width*(xCompass+cos(angCalc)*size*1.6f-300)/1600,height*(yCompass+sin(angCalc)*size*1.6f)/900);//3.15
    } else {
      stroke(255);
      line(width*(xCompass+cos(angCalc)*size*2.2f-300)/1600,height*(yCompass+sin(angCalc)*size*2.2f)/900,width*(xCompass+cos(angCalc)*size*1.9f-300)/1600,height*(yCompass+sin(angCalc)*size*1.9f)/900);
    }
  }
 //pushMatrix();
   //translate(0,-200);
  textFont(font15);
  //scale(width*1.5/1600);
  text("N", width*(xCompass-305)/1600, height*(yCompass-51-size*0.9f)/900);text("S", width*(xCompass-5-300)/1600, height*(yCompass+60+size*0.9f)/900);
  //scale(width*1.1/1600,1);
  text("W", width*(xCompass-size*0.9f-358)/1600, height*(yCompass+6)/900);text("E", width*(xCompass+size*0.9f-252)/1600, height*(yCompass+6)/900);
  // head indicator
  //textFont(font12);
  textSize(width/90);
  noStroke();
  ...
  fill(255,255,127);
  text(head + "\u00b0",width*(xCompass-11-(head>=10.0f ? (head>=100.0f ? 6 : 3) : 0)-300)/1600,height*(yCompass+6)/900);
   //GPS direction indicator
  fill(255,255,0);
  text(GPS_directionToHome + "\u00b0",width*(xCompass-size*2.1f-331)/1600,height*(yCompass+size*2+27)/900);
   //GPS fix
  if (GPS_fix==0) {
     fill(127,0,0);
  } else {
...
*/
 ...
 //text("AIR",xParam+3+200,yParam+32+150);
  ...
  translate(0,0,0);
  popMatrix();
  if (versionMisMatch == 1) {textFont(font15);fill(0xff000000);text("GUI vs. Arduino: Version or Buffer size mismatch",width*180/1600,height*420/900); return;}
 //AIR
 fill(255);
 fill(0);
...
public float rcY(float x) {  
    return cy -100;  
}  
  
public float rcX(float x) {  
    return cx + x;  
}  
  
public void drawbody(float x, float y) {  
    fill(0);  
...
public void shark()
{
   ...
   translate(20,30);
    ...
    static public void main(String[] passedArgs) {
        String[] appletArgs = new String[] { "SUNFOUNDER_GROUND_CONTROL_STATION" };
        if (passedArgs != null) {
