...
/*************************************************************************************************/
  ...
  #define THROTTLE_ANGLE_CORRECTION 40		//40
 ...
 */
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_DELAY     3                     // Guard time for failsafe activation after signal lost. 1 step = 0.1sec - 1sec in example
    #define FAILSAFE_OFF_DELAY 30//200                    // Time for Landing before motors stop in 0.1sec. 1 step = 0.1sec - 20sec in example
...
#define LAND_SPEED          100
  ...
  /********************************************************************/
    ...
    #define VBATSCALE       205//327//131 // (*) (**) change this value if readed Battery voltage is different than real voltage
    #define VBATNOMINAL     42//126 // 12,6V full battery nominal voltage - only used for lcd.telemetry
    #define VBATLEVEL_WARN1 37//107 // (*) (**) 10,7V
    #define VBATLEVEL_WARN2  35//99 // (*) (**) 9.9V
    #define VBATLEVEL_CRIT   33//93 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
  ...
  /********************************************************************/
     ...
     */
    #define BOARD_NAME "FN MiniDroneV1.0"
    //                  123456789.123456
...
/*************************************************************************************************/
  ...
  #define VBAT_PRESCALER 10//16 // set this to 8 if vbatscale would exceed 255
